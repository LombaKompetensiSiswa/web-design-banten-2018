...
<body>
	...
	<div class="col-12" style="margin-bottom: 110px;">
		<div class="container">
			<h1 style="font-weight: normal; font-size: 24px;"><b style="border-bottom: 3px solid #CCC;">Pameran</b> Buku</h1>
			<div class="col-4 gif">
				<div class="angka">1 / 6</div>
				<img src="assets/img/animasi-1.gif">
				<p>
					Ditulis Oleh : Aldian Syahputra <br />
					Terbit Tahun : 2018-2019 <br />
					Di Buat Oleh : Fikri Alam Arya Putra <br />
				</p>
			</div>
			<div class="col-4 gif">
				<div class="angka">2 / 6</div>
				<img src="assets/img/animasi-2.gif">
				<p>
					Ditulis Oleh : Aldian Syahputra <br />
					Terbit Tahun : 2018-2019 <br />
					Di Buat Oleh : Fikri Alam Arya Putra <br />
