...
$(document).ready(function() {
	...
	$('.daycounter').each(function(){
		...
		countDay.setSeconds(countDay.getSeconds() + 30.5);
		// countDay.setMinutes(countDay.getMinutes() + 5.1);
		// countDay = new Date(year, month - 1, date).getTime() + 5000;
		...
		if( counter_type == "down" ) {
			$("#"+counter_id).countdown({
                ...
                onExpiry: function (e)
                {
                	if (doctype == 'AN' || doctype == 'RR') {
                        window.location.href = base_url+'/dataemiten/'+doctype+'/'+type+'/getpengumumandownload/'+emiten;
					} else  {
                        window.location.href = base_url+'/dataemiten/'+doctype+'/'+type+'/getfiledownload/'+emiten;
					}
                }
			});
...
function prettyPhoto() {
	...
	if( $("a[rel^='prettyPhoto'], a[data-rel^='prettyPhoto']").length != 0 ) { 
	 ...
	 $("a[rel^='prettyPhoto'], a[data-rel^='prettyPhoto']").prettyPhoto({hook: 'data-rel', social_tools: false, deeplinking: false,theme:'light_square',modal:true,default_width:'100%'});
...
function GmapInit() {
	  ...
	  Gmap.each(function() {
		...
		var image = 'assets/images/default/map-marker.png';
...
function MapLoadScript() {
	...
	script.src = 'https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCchHJOvBVge0IiVqhZF2PXnl4p8-u0YHk&sensor=false&' + 'callback=GmapInit';
